...
## pattern instead.
## Type: List of UrlPattern
c.content.blocking.whitelist = ["*.a2z.com"]
...
c.editor.command = ['st', '-e', 'nvim', '{file}', '+{line0}']
...
c.fileselect.multiple_files.command = ['st', '-e', 'runvifm', '--choose-files', '{}']
...
## to be written to.
## Type: ShellCommand
c.fileselect.single_file.command = ['st', '-e', 'runvifm', '--choose-files', '{}']
...
c.url.searchengines = {
        ...
        'l': 'https://dict.leo.org/german-english/{}',
        'wg': 'https://de.wikipedia.org/w/index.php?search={}',
        'we': 'https://en.wikipedia.org/w/index.php?search={}',
        'efgit': 'https://github.com/ILC-Technology?q={}',
        'jira': 'https://ef-ilc.atlassian.net/browse/{}'
        }
